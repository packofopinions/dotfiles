...
vim.g.avante_path = vim.fn.expand(xdg_config_home .. 'avante')
...
avante.setup({
    ...
    providers = {
        lmstudio = {
            ...
            endpoint = os.getenv("LMSTUDIO_URL"),
            model='local',
        ...
        timeweb = {
            __inherited_from = 'openai',
            api_key_name = 'TIMEWEB_API_KEY',
            endpoint = os.getenv('TIMEWEB_URL'),
            model = 'timeweb',
            disable_tools = false,
        },
        gpt = {
    ...
    windows = {
        ...
        spinner = {
            editing = { "⣾", "⣽", "⣻" }, -- Уменьшите для скорости
            generating = { "·", "✢", "✳" },
